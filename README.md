...
> Reading Claude Code, Together —— 一本关于 Claude Code 内部机制的深度拆解 · 分三部分:tools 原语设计、agent loop 执行流、context 管理信息流。
...
4. 最后进第三部分(Context 管理) —— 是前两部分的哲学总结
